...
% FILE PARAMETERS
% ---------------
filename = '2D-Square'; % A filename for saving the data (make this parameter dependent for data runs)
...
iterComp = 500; % The number of iterations for optimising composite bands
